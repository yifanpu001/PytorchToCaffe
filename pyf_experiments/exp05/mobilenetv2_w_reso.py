...
if __name__ == '__main__':
    ...
    input_tensor = Variable(torch.ones([32, 3, input_size[0], input_size[1]]))
    ...
    model = mobilenet_v2(inverted_residual_setting=inverted_residual_setting)
    model.eval()

    save_path = '/home/pyf/codeforascend/PytorchToCaffe/converted_models'
    name = f'exp05/mobilenetv2_width{str(t)}_re{str(input_size[0])}x{str(input_size[1])}'
    ...
    caffe_model_name = f'exp05_mobilenetv2_width{str(t)}_re{str(input_size[0])}x{str(input_size[1])}'
